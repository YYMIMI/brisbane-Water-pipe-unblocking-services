  ...
  <section class="section reviews-section" aria-labelledby="reviews-title">
    <div class="reviews-heading">
      <div>
        ...
        <p>A selection of comments previously shared about the MelOne team? work.</p>
      </div>
...
const homePage = () => ({
  ...
  body: `
    ...
    <section class="section photo-s…4798 tokens truncated…3",
  body: `
    <main>
      <section class="inner-hero about-hero">
        <nav class="breadcrumbs" aria-label="?Ｗ?撅紡??><ol><li><a href="/">English</a></li><li><span aria-current="page">銝剜?</span></li></ol></nav>
        <div class="inner-hero-grid">
          <div class="reveal">
            <p class="eyebrow">MelOne 銝剜??</p>
            <h1>撣??舐蝞⊿??萄?嚗????菔秩皜???/h1>
          </div>
          <div class="inner-hero-aside reveal">
            <p>?? Felix2 ?冽??函?撣??舐??銝銝芣?瘞游?萄?嚗誑??行?蝘舀偌???喋??ㄟ????隞砌?蝖株恕???憸漲?園??/p>
      ...
      <section class="section split-intro">
        <div><p class="eyebrow">撣貉??偌?桅?</p><h2>雿??蝘銝??砍?振??/h2></div>
        <p>?賑憭?撣??舐撣貉???瘞游憛霂Ｕ??萇揮?交嚗窈??甇Ｖ蝙?典?敶勗???瘞游嚗僎撠賡??????冽偌??/p>
      </section>

      <section class="section section-tight" aria-label="銝剜??偌?">
        <div class="service-grid">
          <article class="service-card reveal"><span class="service-number">01</span><p class="eyebrow">瘞港?銝???</p><h3>?萄??偌蝞?/h3><p>瘣???瘚氬瞍?摰文??偌???瘞渡??Ｕ??箏??ㄟ?滯瘞氬?/p><a class="text-link" href="/blocked-drains-brisbane/">?亦??望??憿?<span aria-hidden="true">??/span></a></article>
          <article class="service-card reveal"><span class="service-number">02</span><p class="eyebrow">?Ｘ?瘞港?撘</p><h3>?偌皜?</h3><p>憭?蝘臬??憭?啁?撘嚗誑???亥??Ｙ??冽?絕摰斗?瘞氬?/p><a class="text-link" href="/drain-cleaning-brisbane/">?亦??望??憿?<span aria-hidden="true">??/span></a></article>
          <article class="service-card reveal"><span class="service-number">03</span><p class="eyebrow">?怎??港??冽</p><h3>撽祆▲?????萄?</h3><p>撽祆▲??踵偌瑽賬絕摰斗?????瘚湔?瘞湧憸?/p><a class="text-link" href="/toilet-sink-blockages/">?亦??望??憿?<span aria-hidden="true">??/span></a></article>
          <article class="service-card reveal"><span class="service-number">04</span><p class="eyebrow">摰文?蝘舀偌</p><h3>?冽偌?偌</h3><p>撣??舐憭折?????嗆楔蝘臬?摰文?蝘舀偌?桅???/p><a class="text-link" href="/stormwater-drain-cleaning/">?亦??望??憿?<span aria-hidden="true">??/span></a></article>
        </div>
      </section>

      <section class="section why-section" aria-labelledby="zh-why-title">
        <div class="why-heading reveal">
          <p class="eyebrow">銝箔?銋 MelOne</p>
          <h2 id="zh-why-title">銝銝芾?蝟颱犖嚗?璆???/h2>
          <p>?湔?頂 Felix2?窈????蝻??啣?嚗?隞砌??＆霈斗??∟??港??園??/p>
        </div>
        <div class="why-grid">
          <article class="why-card reveal"><span>01</span><h3>?湔?頂</h3><p>?菔??蝞勗?函?靽?銝?湛?銝?閬?憭粉?曇?蝟颱犖??/p></article>
          <article class="why-card reveal"><span>02</span><h3>霂湔??賢?摰?</h3><p>??閫??憛??嗅?憪?隞亙??嗡??偌???虫??蔣??/p></article>
          <article class="why-card reveal"><span>03</span><h3>撣??舐銝?</h3><p>????蝻?嚗?隞砌?蝖株恕敶予??蝔??舫?蝥行?氬?/p></article>
          <article class="why-card reveal"><span>04</span><h3>雿?銝?啣?摰?/h3><p>?臬霂Ｖ?摰蝘銝銝恣??撠??振??瘞湧憸?/p></article>
        </div>
      </section>
      ...
      ${brisbaneMap({
        ...
        eyebrow: "??箏??啣",
        heading: "??Google ?啣?亦? Mel One Renovations",
        copy: "雿輻?啣?亦? Mel One Renovations ?振韏???孵?頝舐瑪??,
        linkText: "??Google ?啣銝剜??Mel One Renovations",
      })}

      <section class="contact-band" aria-labelledby="zh-contact-title">
        <div>
          <p class="eyebrow eyebrow-light">銝剜??刻砭</p>
          <h2 id="zh-contact-title">???賑?芷??萄???/h2>
          <p>?頂 Felix2 ?嗉窈??撣??舐??蝻憛?蝵桀?敶????/p>
        </div>
        <div class="contact-band-actions">
          <a class="button button-light" href="tel:${PHONE_HREF}">?菔? ${PHONE_DISPLAY}</a>
...
const header = (path) => `
  ...
  <header class="site-header">
    <a class="brand" href="/" aria-label="MelOne home"><span class="brand-logo-crop" aria-hidden="true"><img src="/melone-logo.png" alt="" width="960" height="960"></span><span class="brand-copy"><strong class="brand-wordmark">MELONE</strong><span class="brand-tag">Drain care 繚 Brisbane</span></span></a>
    ...
    <nav class="site-nav" id="site-nav" aria-label="Primary navigation">
      ...
      <a ${path === "/zh/" ? 'aria-current="page"' : ""} href="/zh/" lang="zh-Hans">銝剜?</a>
...
const footer = () => `
  <footer class="site-footer">
    ...
    <div class="footer-bottom"><span>穢 MelOne</span><span>Brisbane drain clearing</span></div>
  </footer>
