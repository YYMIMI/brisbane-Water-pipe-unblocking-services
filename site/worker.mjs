...
const areaImmediateStep = {
  "Inner Brisbane": "If wastewater is entering a unit or common area, stop using affected fixtures where possible and contact the person responsible for building access. Keep people clear of the overflow.",
  "Northside": "If an outside gully is rising while household fixtures are used, reduce water use and note which fixture triggers the rise. Leave covered inspection points closed for the attending trade.",
  "Southside": "Stop using a blocked toilet, sink or shower rather than repeatedly flushing or running water. If other fixtures also back up, reduce water use across the property and tell the team.",
  "East & bayside": "For rain-related pooling, stay clear of flooded electrical equipment and record where the water first appears from a safe position. Do not enter a flooded drain or open a chamber.",
  "West & outer suburbs": "If flow has returned but the blockage keeps recurring, keep any previous clearing or camera report and note when the problem returns. That history may change the next inspection.",
};
const areaQuoteHelp = {
  "Inner Brisbane": {
